...
window.MinePhone = (function () {
  ...
  function renderMainPage() {
    ...
    pageEl.querySelector("#phone-single-call").addEventListener("click", showSingleCallPicker);
    pageEl.querySelector("#phone-group-call").addEventListener("click", showGroupCallPicker);
  }
  ...
  function showSingleCallPicker() {
    ...
    pageEl.innerHTML = navHtml + bodyHtml;
    pageEl.querySelector('[data-act="back"]').addEventListener("click", renderMainPage);
  ...
  function bindCallButtons() {
    var hangupOut = document.getElementById("phone-hangup-out");
    if (hangupOut) hangupOut.addEventListener("click", function () {
      endCall("cancelled");
    });

    var hangupActive = document.getElementById("phone-hangup-active");
    if (hangupActive) hangupActive.addEventListener("click", function () {
      endCall("ended");
    });

    var decline = document.getElementById("phone-decline");
    if (decline) decline.addEventListener("click", function () {
      endCall("declined");
    });

    var answer = document.getElementById("phone-answer");
    ...
    var done = document.getElementById("phone-done");
    if (done) done.addEventListener("click", function () {
      currentCall = null;
      renderMainPage();
    });

    var minimize = document.getElementById("phone-minimize");
    if (minimize) minimize.addEventListener("click", function () {
      currentCall = null;
      if (window.MineApp) MineApp.goHome();
    });
  }
