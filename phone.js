...
window.MinePhone = (function () {
  ...
  /* ---------------- 事件绑定辅助 ----------------
     body 已设 touch-action: manipulation，click 在移动端无 300ms 延迟 */
  ...
  function renderMainPage() {
    ...
    bindClick(pageEl.querySelector('[data-act="back"]'), function () {
      if (window.MineApp) MineApp.goHome();
    });
    bindClick(pageEl.querySelector("#phone-single-call"), showSingleCallPicker);
    bindClick(pageEl.querySelector("#phone-group-call"), showGroupCallPicker);
  }
  ...
  function showSingleCallPicker() {
    ...
    pageEl.innerHTML = navHtml + bodyHtml;
    bindClick(pageEl.querySelector('[data-act="back"]'), renderMainPage);
  ...
  function bindCallButtons() {
    bindClick(document.getElementById("phone-hangup-out"), function () {
      endCall("cancelled");
    });

    bindClick(document.getElementById("phone-hangup-active"), function () {
      endCall("ended");
    });

    bindClick(document.getElementById("phone-decline"), function () {
      endCall("declined");
    });

    bindClick(document.getElementById("phone-answer"), function () {
    ...
    bindClick(document.getElementById("phone-done"), function () {
      currentCall = null;
      renderMainPage();
    });

    bindClick(document.getElementById("phone-minimize"), function () {
      currentCall = null;
      if (window.MineApp) MineApp.goHome();
    });
  }
